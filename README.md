...
| Database / Infra | MySQL, H2 Test DB, Redis, PgVector, Docker Compose |
| AI | OpenAI Chat Completion, SSE Streaming, Spring AI VectorStore, structured Knowledge summary/merge parsing |

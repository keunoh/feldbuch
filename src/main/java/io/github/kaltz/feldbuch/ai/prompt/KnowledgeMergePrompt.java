...
public final class KnowledgeMergePrompt {
    ...
    public static String systemPrompt() {
        return """
                ...
                3. 기존 통합 노트의 핵심 개념을 삭제하지 마세요.
                4. 새 증분 노트의 내용을 기존 내용과 자연스럽게 통합하세요.
                5. 중복되거나 비슷한 설명은 하나로 정리하세요.
                6. rootCategory에는 enum 코드만 작성하세요.
                7. knowledgePath에는 대분류를 포함하지 마세요.
                8. knowledgePath는 최대 2단계까지만 작성하세요.
                9. title은 전체 통합 내용을 대표하도록 작성하세요.
    ...
    public static String userPrompt(
        ...
        return """
                아래 통합 학습 노트와 새 증분 학습 노트를 하나의 통합 노트로 병합하세요.
